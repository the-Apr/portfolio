    ...
    <div class="work-wrap">
      ...
      <div class="right">
        ...
        <div class="projectcard-wrap">
          <project-card  :post="post" v-for="(post, index) in sampleBlogCards" :key="index"></project-card>
        </div>
      </div>
  ...
  .work-wrap {
    ...
    .right{
      ...
      .explore {
        ...
        h3{
          @apply tracking-widest text-2xl;
        }
        span{
          font-weight: 800;
          font-size: 40px;
      ...
      .projectcard-wrap {
        @apply w-full grid grid-cols-1 grid-flow-dense gap-5 mt-5;
